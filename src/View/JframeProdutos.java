...
public class JframeProdutos extends javax.swing.JFrame {
    ...
    try {
        formatoNumeros = new MaskFormatter("####");
    } catch (Exception e) {
        //TODO: handle exception
        JOptionPane.showMessageDialog(null, "formato invalido", "Erro", 0, new ImageIcon(
            "C:\\Users\\gesse\\OneDrive\\Documentos\\NetBeansProjects\\ProjetoCrudQ2\\src\\Imagens\\btn_sair.png"));
    ...
    txtQdt.setDocument(new ControleCampo(ControleCampo.decimal,EnumCampo.SOMENTE_NUMERO));
    jLabel5 = new javax.swing.JLabel();
    txtVunitario = new javax.swing.JTextField();
    txtVunitario.setDocument(new ControleCampo(ControleCampo.decimal,EnumCampo.CASAS_DECIMAIS));
    ...
    private void txtVunitarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtVunitarioKeyTyped
    ...
    private void btn_consultaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_consultaActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Clique no novo para e escreva algo para fazer a consulta");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JframeProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
